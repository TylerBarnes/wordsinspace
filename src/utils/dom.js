...
export const getResponsiveBrowserVars = (breakpoint) => { 
  return {
    ...
    listWidth: breakpoint !== 'lg' ? global_mobile_width : '75vw', // this goes into components/list.js and components/list/listItem.js, it controls the width of the List component. The List expands to 100vw since we don't have side Filters on mobile.
