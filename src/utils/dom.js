...
export const getResponsiveBrowserVars = (breakpoint) => { 
  return {
    ...
    listWidth: breakpoint !== 'lg' ? global_mobile_width : '100%', // this goes into components/list.js and components/list/listItem.js, it controls the width of the List component. The List expands to 100vw since we don't have side Filters on mobile.
    listTitleWidth: breakpoint !== 'lg' ? global_mobile_width : '50%', // this goes into components/list.js and components/list/listItem.js, it controls the width of the Title in each ListItem. Titles expand almost fully in mobile, they are constrated at 50vw when not on mobile.
  }
}
