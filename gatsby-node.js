...
exports.createPages = async ({ actions, graphql }) => {
  ...
  createRedirect({ fromPath: '/shannon-archive-2017/:year/:month/:slug', toPath: 'https://icd.wordsinspace.net/wp-content/uploads/:year/:month/:slug', isPermanent: true, force: true, statusCode: 301 })
